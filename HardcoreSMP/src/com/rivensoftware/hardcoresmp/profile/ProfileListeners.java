...
public class ProfileListeners implements Listener
{
	...
	public void onPlayerJoinEvent(PlayerJoinEvent event) 
	{
		...
		int version = ViaVersionPlugin.getInstance().getApi().getPlayerVersion(player);

		//ORGANIZE THIS 
		if(version < 755)
		{
			player.kickPlayer(MessageTool.color("&cKingdoms (HardcoreSMP) only supports minecraft version 1.17 and above! Please reconnect."));
			return;
		}
