...
public class WallBannerNegativeEffectsShop 
{
	public static Menu bannerWallNegativeEffectsShopMenu() 
	{
	...
	public static void displayWallBannerNegativeEffectsShopMenu(Player player) 
	{
		Menu menu = bannerWallNegativeEffectsShopMenu();
		...
		for(WallBannerNegativeEffects effects : WallBannerNegativeEffects.values())
		{
			...
			entry.setItemTemplate(p -> 
			{
				...
				lore.add(MessageTool.color("&7to &cenemies &7that enter your territory"));
				lore.add(MessageTool.color("&7by &fplacing this banner &7somewhere"));
